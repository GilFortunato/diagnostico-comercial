...
import { buildNextBestSocialSellingAction } from "@/lib/social-selling/socialSellingStrategy";
...
export function AuthorityDiagnostic() {
  ...
  const nextBestAction = assessment ? buildNextBestSocialSellingAction(assessment) : null;
  ...
  function handleNextAction(action: string) {
    ...
    const recommendation = buildNextBestSocialSellingAction(assessment);
