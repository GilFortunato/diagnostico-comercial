...
import { markHumanshipMessageCopied, saveHumanshipRoleRule, updateHumanshipDecision } from "@/lib/humanship/service";
...
const schema = z.discriminatedUnion("action", [decisionSchema, copiedSchema, roleRuleSchema]);
